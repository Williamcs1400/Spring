...
public class CreatDemo {
	...
	public static void main(String[] args) {
		...
		try {	
			//Create the objects
			Instructor tempInstructor = new Instructor("Leandro", "Coelho", "Leandro@coelho.com");
			
			InstructorDetail tempInstructorDetail = new InstructorDetail("www.leandro.com.br", "Xesque");
